...
## Find path of the script then find the path of parent folder and add it to system path to import local libraries ##
...
loggername = 'extract_mysql_incremental'
...
## Connect to source and extract data greater than last_updated_target timestamp ##
select_orders_query = queries.select_orders_incremental_query
source_connection = cf.connect_mysql()
source_cursor = source_connection.cursor()
source_cursor.execute(select_orders_query, {'max_update_orders' : last_updated_target})
